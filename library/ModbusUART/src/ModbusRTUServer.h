...
#ifndef _MODBUS_RTU_SERVER_H_
#define _MODBUS_RTU_SERVER_H_
...
public:
  ModbusRTUServer(RS485& rs485);
  virtual ~ModbusRTUServer();
  ...
  int begin(RS485& rs485, int id, unsigned long baudrate, uint16_t config = SERIAL_8N1);
